        ...
        <div class="col-md-12">
          ...
          <div class="row" style="min-height:400px">
           ...
           <div class="col-md-6">
              ...
              <label for="date">Select Equipment</label>
                ...
                <input type="hidden" name="borrower" value="<?php echo $bid;?>"  required>
              </div><!-- /.form group -->
          </div>
          <div class=" col-md-2">
            <div class="form-group">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <div class="input-group">
                <button class="btn btn-lg btn-block btn-info" type="submit" tabindex="3" name="addtocart">+</button>
              </div>
            </div>  
          </form> 
          </div>
           <div class="col-md-2">
            <div class="form-group">
              <label for="date"></label>
              <div class="input-group">
                <a href="home.php" class="btn btn-lg btn-block btn-success">Finish</a>
              </div>
            </div>  
...
<?php
    ...
    $query=mysqli_query($con,"select * from borrow natural join equipment where member_id='$bid'")or die(mysqli_error($con));
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Delete Borrowed Equipment</h4>
              </div>
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="borrow_del.php" enctype='multipart/form-data'>
        ...
        <p>Are you sure you want to remove <?php echo $row['equipment_name'];?>?</p>
