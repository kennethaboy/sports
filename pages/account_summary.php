...
<html>
  <head>
    ...
    <title>Customer Account | Inventory System</title>
      ...
      <div class="content-wrapper">
        <div class="container">
		  ...
		  ?>	
                 ...
                 <a href="#" data-target="#teacherreg" data-toggle="modal" class="btn btn-primary"><i class="glyphicon glyphicon-plus-sign text-blue"></i>Add New Account</a>
				</form>	
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col (right) -->
...
<?php
		$cid=$_REQUEST['cid'];
		$query=mysqli_query($con,"select * from account where cust_id='$cid' order by date desc")or die(mysqli_error());
