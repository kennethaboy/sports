  ...
  <body class="hold-transition skin-green-light layout-top-nav">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-12"><h2>Sales Report as of <?php echo date("M d, Y");?></h2>
...
<?php
	if (isset($_POST['display']))
	{
		...
		$query=mysqli_query($con,"select *,SUM(price*qty) as total from stockout where date(date)>='$start' and date(date)<='$end' group by date(date)
